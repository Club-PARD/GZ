...
export default function PrivacyModal({ open, onClose }: ModalProps) {
  if (!open) return null;
  return (
    <div className="fixed flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl w-11/12 max-w-2xl p-6 relative">
        ...
        <h2 className="text-2xl font-bold mb-4">개인정보 수집∙이용 동의</h2>
        {/* TODO: 실제 개인정보 수집∙이용 내용을 여기에 넣어주세요 */}
        <div className="h-64 overflow-auto border p-4">
          <p>여기에 개인정보 수집∙이용 동의 전문을 넣어주세요.</p>
        </div>
      </div>
    </div>
  );
