...
const TransactionTable: React.FC<TransactionTableProps> = ({
  ...
  <div className="overflow-x-auto border-b border-gray-200">
    <div className="grid w-full [grid-template-columns:2fr_0.5fr_0.5fr] divide-y divide-x divide-gray-200 border-x border-gray-200 text-gray-600 font-medium border-t">
