      ...
      <div className="min-h-screen bg-gray-50 flex flex-col items-center pt-16">
        ...
        <div className="flex justify-center space-x-4 mb-8">
          <div className="flex items-center bg-gray-200 rounded-lg px-4 py-2 space-x-2">
            <span className="w-6 h-6 bg-black text-white rounded-lg flex items-center justify-center">1</span>
        ...
        {/* 인증 카드 */}
        <div className="w-full max-w-md bg-[#F5F5F5] p-8 rounded-2xl space-y-6">
          {/* 학교 */}
          <div>
