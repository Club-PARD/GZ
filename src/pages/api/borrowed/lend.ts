// src/pages/api/borrowed/lend.ts
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const backendUrl = `${process.env.NEXT_PUBLIC_API_URL}/borrowed/lend${queryString ? `?${queryString}` : ''}`;
    ...
    console.error('Error in /api/borrowed/lend:', error);
